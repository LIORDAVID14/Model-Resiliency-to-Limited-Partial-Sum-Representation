...
class NeuralNet:
    ...
    def test(self, test_gen, iterations=None):
        ...
        with torch.no_grad():
            ...
            #FOR ALL LAYERS
            #TOP 1
            with open('resnet18_imagenet_8_x_w_limit_bits_psum_from_17_and_save_MSB_from_0_to_17_DYNAMIC_TOP1.txt', 'a') as f:
                print('{top1.avg:.3f}'.format(top1=top1, top5=top5), file=f)
                f.close()
            #TOP 5
            with open('resnet18_imagenet_8_x_w_limit_bits_psum_from_17_and_save_MSB_from_0_to_17_DYNAMIC_TOP5.txt', 'a') as f:
                print('{top5.avg:.3f}'.format(top1=top1, top5=top5), file=f)
                f.close()
    ...
    def _adjust_lr_rate(self, optimizer, epoch, lr_dict):
        ...
        for key, value in lr_dict.items():
            if epoch == key:
                print("=> New learning rate set to {}".format(value))
